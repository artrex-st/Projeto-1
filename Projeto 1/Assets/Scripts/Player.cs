...
public class Player : MonoBehaviour
{
    ...
    {
        return Physics2D.BoxCast(new Vector2(transform.localPosition.x, transform.localPosition.y), new Vector2(transform.localScale.x * 0.5f, transform.localScale.y * 1.01f), 0, Vector2.down,0.2f, GroundLayer);  
    }
